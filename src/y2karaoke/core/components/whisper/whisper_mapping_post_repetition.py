...
def _pull_adjacent_similar_lines_across_long_gaps(
    ...
    *,
    ...
    return _cadence_helpers.pull_adjacent_similar_lines_across_long_gaps(
        lines,
...
def _smooth_adjacent_duplicate_line_cadence(
    ...
    *,
    ...
    return _cadence_helpers.smooth_adjacent_duplicate_line_cadence(
        lines,
        normalize_match_token_fn=_normalize_match_token,
        soft_token_overlap_ratio_fn=_soft_token_overlap_ratio,
        min_gap=min_gap,
        target_gap=target_gap,
        min_adjust_gap=min_adjust_gap,
        max_adjust_gap=max_adjust_gap,
        max_pull=max_pull,
    )
...
def _rebalance_short_question_pairs(
    ...
    *,
    ...
    return _cadence_helpers.rebalance_short_question_pairs(
        lines,
        normalize_match_token_fn=_normalize_match_token,
...
def _extend_line_to_trailing_whisper_matches(
    ...
    *,
    ...
    return _tail_extension_helpers._extend_line_to_trailing_whisper_matches(
        mapped_lines,
        all_words,
        normalize_match_token_fn=_normalize_match_token,
        soft_token_match_fn=_soft_token_match,
