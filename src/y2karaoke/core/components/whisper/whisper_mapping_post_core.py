...
def _default_postprocess_toggle_config(
    runtime_config: WhisperRuntimeConfig | None = None,
) -> _WhisperPostprocessToggleConfig:
    resolved_runtime_config = runtime_config or load_whisper_runtime_config()
    return _WhisperPostprocessToggleConfig(
        disable_repeat_shift=resolved_runtime_config.disable_repeat_shift,
        disable_monotonic_start_enforce=(
            resolved_runtime_config.disable_monotonic_start_enforce
        ),
    )
...
def _shift_repeated_lines_to_next_whisper(
    ...
    *,
    ...
    config = _default_postprocess_toggle_config(runtime_config)
