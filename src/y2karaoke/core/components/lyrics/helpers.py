...
from .helpers_plain_text_layout import (
    _apply_anchor_specific_plain_text_layout,
    _apply_special_plain_text_layout_if_any,
    _plain_text_layout_shape_flags,
    _special_plain_text_or_spread,
)
...
from .lyrics_clip_mixed_density_helpers import (
    build_mixed_density_chorus_layout as _build_mixed_density_chorus_layout_impl,
    ...
    *,
    ...
    if not vocals_path:
        return _special_plain_text_or_spread(
            ...
            spread_lines_across_target_duration_fn=_spread_lines_across_target_duration,
        )
...
def _is_mixed_density_chorus_clip(
    *,
    ...
    return _is_mixed_density_chorus_clip_impl(
        lines=lines,
        duration=duration,
...
def _build_mixed_density_chorus_layout(
    ...
    return _build_mixed_density_chorus_layout_impl(
        lines,
        normalize_text_fn=_normalize_line_weight_text,
        estimate_singing_duration_fn=_estimate_singing_duration,
    )
