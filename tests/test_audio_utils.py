...
from y2karaoke.core.audio_utils import trim_audio_if_needed, apply_audio_effects, separate_vocals
...
class TestTrimAudioIfNeeded:
    ...
    def test_function_signature(self):
        ...
        expected_params = ['audio_path', 'start_time', 'video_id', 'cache_manager', 'force']
    ...
    def test_uses_cached_result_when_available(self):
        ...
        result = trim_audio_if_needed("/audio.wav", 3.0, "video123", mock_cache, force=False)
    ...
    def test_force_retrim_ignores_cache(self, mock_from_wav):
        ...
        result = trim_audio_if_needed("/audio.wav", 2.0, "video123", mock_cache, force=True)
...
class TestApplyAudioEffects:
    ...
    def test_function_signature(self):
        ...
        params = list(sig.parameters.keys())
        expected_params = ['audio_path', 'key_shift', 'tempo', 'video_id', 'cache_manager', 'audio_processor', 'force', 'cache_suffix']
        for param in expected_params:
            assert param in params
    ...
    def test_no_effects_returns_original(self):
        ...
        result = apply_audio_effects("/audio.wav", 0, 1.0, "video123", mock_cache, mock_processor)
        assert result == "/audio.wav"
    ...
    def test_applies_effects_when_needed(self):
        ...
        result = apply_audio_effects("/audio.wav", 2, 1.2, "video123", mock_cache, mock_processor)
    ...
    def test_uses_cached_result_when_available(self):
        ...
        result = apply_audio_effects("/audio.wav", 1, 0.8, "video123", mock_cache, mock_processor)
    ...
    def test_force_reprocess_ignores_cache(self):
        ...
        result = apply_audio_effects("/audio.wav", -1, 1.0, "video123", mock_cache, mock_processor, force=True)
...
class TestSeparateVocals:
    ...
    def test_function_signature(self):
        ...
        params = list(sig.parameters.keys())
        expected_params = ['audio_path', 'video_id', 'separator', 'cache_manager', 'force']
        for param in expected_params:
            assert param in params
    ...
    def test_separates_vocals_when_not_cached(self):
        ...
        expected = {'vocals_path': '/vocals.wav', 'instrumental_path': '/instrumental.wav'}
    ...
    def test_uses_cached_result_when_available(self):
        ...
        expected = {'vocals_path': '/cached_vocals.wav', 'instrumental_path': '/cached_instrumental.wav'}
        assert result == expected
    ...
    def test_force_reseparate_ignores_cache(self):
        ...
        result = separate_vocals("/audio.wav", "video123", mock_separator, mock_cache, force=True)
...
class TestAudioUtilsErrorHandling:
    ...
    def test_apply_effects_handles_processor_errors(self):
        ...
        with pytest.raises(Exception):
            apply_audio_effects("/audio.wav", 2, 1.0, "video123", mock_cache, mock_processor)
...
class TestAudioUtilsCaching:
    ...
    def test_apply_effects_caching_logic(self):
        ...
        # Test cache hit
        mock_cache.file_exists.return_value = True
        result = apply_audio_effects("/audio.wav", 1, 1.0, "video123", mock_cache, mock_processor)
