...
class TestDetectAudioSilenceRegions:
    ...
    def test_detects_silence_regions(self, mock_frames_to_time, mock_rms, mock_load):
        ...
        silence_regions = detect_audio_silence_regions("test.wav", min_silence_duration=0.5)
...
class TestAdjustTimingForDurationMismatch:
    ...
    def test_early_exit_when_durations_match(self, mock_tolerance, mock_silence, mock_gaps):
