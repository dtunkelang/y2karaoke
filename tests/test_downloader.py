...
class TestConvenienceFunctions:
    ...
    def test_download_audio_function_exists(self, mock_downloader_class):
        ...
        mock_instance.download_audio.assert_called_once_with('https://youtube.com/watch?v=test', None)
    ...
    def test_download_video_function_exists(self, mock_downloader_class):
        ...
        mock_downloader_class.assert_called_once()
        mock_instance.download_video.assert_called_once_with('https://youtube.com/watch?v=test', None)
...
class TestModuleIntegration:
    ...
    def test_downloader_has_required_methods(self):
        ...
        downloader = YouTubeDownloader()
        required_methods = ['get_video_title', 'get_video_uploader', 'download_audio', 'download_video']
    ...
    def test_metadata_methods_return_format(self, mock_ytdl):
        ...
        mock_instance = Mock()
        mock_instance.extract_info.return_value = {'title': 'Test', 'uploader': 'Channel'}
        mock_ytdl.return_value.__enter__.return_value = mock_instance
